...
public class AStar
{
    ...
    private static List<Node> ExpandNode(Node node, Node target, HashSet<string> obstacles, Dictionary<string, Node> fringe, Dictionary<string, Node> visited) {
    ...
    private static Node SurvivalSearch(Node agent, HashSet<string> obstacles) {
        // Fallback logic
        return agent;
    }
}