...
public class KafkaConfig
{
    ...
    public KafkaConfig(string groupId, bool isClient = false)
    {
        if (isClient)
        {
            _kafkaServers = "34.32.33.189:30001,34.32.33.189:30002,34.32.33.189:30003";
            _schemaRegistry = "34.32.33.189:30004";
        }
